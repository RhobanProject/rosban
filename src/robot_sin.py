...
from math import radians, degrees, sin, pi
...
if __name__ == '__main__':
    ...
    # for k, d in r.publishers.iteritems():
    #     print k

    rate = rospy.Rate(50)

    while not rospy.is_shutdown():
        s = 0.2 * sin(2.0 * pi * rospy.get_time())
        # print degrees(s)
        r.publishers[37].publish(s)
        print 'total error', r.nb_error
        rate.sleep()
